document.addEventListener('DOMContentLoaded', function() {
    ...
    runQueryButton.addEventListener('click', function () {
        ...
        fetch('#NOME-DA-API', {
            ...
            body: JSON.stringify({ ano, mesInicial, mesFinal, idAtivo, query }),
        })
...
function formatarConsulta() {
    ...
    const consulta = `SELECT * FROM extracoes WHERE ano = '${ano}' AND mes BETWEEN '${mesInicial}' AND '${mesFinal}' AND id_ativo = '${idAtivo}';`;
